...
if (start) {
  ...
  final public void mediaList(SACMediaListImpl ml) throws ParseException {MediaQuery mq;
    try {
      mq = mediaQuery();
...
{if ("" != null) return LangUtils.join(selectors, ", ");}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return pseudos.toString();}
    throw new Error("Missing return statement in function");
}
...
//
  final public String pseudoPage() throws ParseException {Token t;
    jj_consume_token(COLON);
    t = jj_consume_token(IDENT);
{if ("" != null) return ":" + unescape(t.image, false);}
    throw new Error("Missing return statement in function");
}
...
{if ("" != null) return new LexicalUnitImpl(prev, LexicalUnit.SAC_OPERATOR_SLASH);}
      break;
      }
    case COMMA:{
      jj_consume_token(COMMA);
...
{if ("" != null) return LexicalUnitImpl.createComma(prev);}
      break;
      }
    default:
      jj_la1[50] = jj_gen;
...
{if ("" != null) return selectors;}
  ...
  final public SelectorList selectorList() throws ParseException {SelectorListImpl selList = new SelectorListImpl();
    Selector sel;
    sel = selector();
if (sel instanceof Locatable) { selList.setLocator(((Locatable) sel).getLocator()); }
    label_42:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case COMMA:{
...
//  ;
//
  final public Selector simpleSelector(Selector sel, char comb) throws ParseException {SimpleSelector simpleSel = null;
    Condition c = null;
...
if (o instanceof Condition)
      ...
      case LSQUARE:
      case HASH:{
simpleSel = getSelectorFactory().createSyntheticElementSelector();
        label_47:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case HASH:{
...
if (c != null) {
            ...
            if (sel == null) {
                ...
                case '>':
                    ...
                    break;
                case '~':
                    sel = getSelectorFactory().createGeneralAdjacentSelector(sel.getSelectorType(), sel, simpleSel);
                    break;
                }
            }
...
//   ;
//
  final public Condition _class(Condition pred, boolean pseudoElementFound) throws ParseException {Token t;
    Locator locator;
...
if (pseudoElementFound) { {if (true) throw pe;} }
            Condition c = getConditionFactory().createClassCondition(null, unescape(t.image, false), locator);
            {if ("" != null) return (pred == null) ? c : getConditionFactory().createAndCondition(pred, c);}
    } catch (ParseException e) {
...
//   ;
//
  final public SimpleSelector elementName() throws ParseException {Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case IDENT:{
        t = jj_consume_token(IDENT);
{if ("" != null) return getSelectorFactory().createElementSelector(null, unescape(t.image, false), createLocator(token));}
        break;
        }
      case ASTERISK:{
        jj_consume_token(ASTERISK);
{if ("" != null) return getSelectorFactory().createElementSelector(null, null, createLocator(token));}
        break;
        }
      default:
        jj_la1[73] = jj_gen;
...
//   ;
//
  final public Condition attrib(Condition pred, boolean pseudoElementFound) throws ParseException {Token t;
    String name = null;
    String value = null;
    int type = 0;
    Locator locator;
...
Condition c = null;
            ...
            case 3:
                ...
                break;
            case 4:
                c = getConditionFactory().createPrefixAttributeCondition(name, null, null != value, value);
                break;
            case 5:
                c = getConditionFactory().createSuffixAttributeCondition(name, null, null != value, value);
                break;
            case 6:
                c = getConditionFactory().createSubstringAttributeCondition(name, null, null != value, value);
                break;
            }
...
//  ;
//
  final public Object pseudo(Condition pred, boolean pseudoElementFound) throws ParseException {Condition c = null;
    Token t;
    String function;
    Selector sel;
...
String s = unescape(t.image, false);
                ...
                if ("first-line".equals(s)
                    ...
                    || "after".equals(s))
                {
                    {if ("" != null) return getSelectorFactory().createPseudoElementSelector(null, s, locator, doubleColon);}
                }
                c = getConditionFactory().createPseudoClassCondition(null, s, locator, doubleColon);
...
if (pseudoElementFound) { {if (true) throw toCSSParseException("duplicatePseudo", new String[] { function + arg + ")" }, locator);} }
                    c = getConditionFactory().createPseudoClassCondition(null, function + arg + ")", locator, doubleColon);
                    {if ("" != null) return (pred == null)
                        ? c
                        : getConditionFactory().createAndCondition(pred, c);}
        break;
...
if (pseudoElementFound) { {if (true) throw toCSSParseException("duplicatePseudo", new String[] { "lang(" + lang + ")" }, locator);} }
                    c = getConditionFactory().createLangCondition(lang, locator);
                    {if ("" != null) return (pred == null)
                        ? c
                        : getConditionFactory().createAndCondition(pred, c);}
        break;
...
if (pseudoElementFound) { {if (true) throw toCSSParseException("duplicatePseudo", new String[] { function + args.toString().trim() + ")" }, locator);} }
                    c = getConditionFactory().createPseudoClassCondition(null, function + args.toString().trim() + ")", locator, doubleColon);
                    {if ("" != null) return (pred == null)
                        ? c
                        : getConditionFactory().createAndCondition(pred, c);}
        break;
...
{if ("" != null) return null;}
  ...
  final public Condition hash(Condition pred, boolean pseudoElementFound) throws ParseException {Token t;
    ParseException pe = null;
    try {
if (pseudoElementFound) { pe = generateParseException(); }
      t = jj_consume_token(HASH);
if (pseudoElementFound) { {if (true) throw pe;} }
            Condition c = getConditionFactory().createIdCondition(unescape(t.image.substring(1), false), createLocator(token));
            {if ("" != null) return (pred == null) ? c : getConditionFactory().createAndCondition(pred, c);}
    } catch (ParseException e) {
...
if (op != ' ') { locator = createLocator(token); }
    ...
    case STRING:{
      t = jj_consume_token(STRING);
value = LexicalUnitImpl.createString(prev, unescape(t.image, false), t.image);
      break;
      }
    case 114:{
...
value = LexicalUnitImpl.createIdent(prev, skipUnit().trim());
    ...
    case IDENT:{
      ...
      case COLON:{
        jj_consume_token(COLON);
{if (true) throw toCSSParseException("invalidExprColon", new String[]{ unescape(t.image, false) }, createLocator(token));}
        break;
        }
      default:
        jj_la1[104] = jj_gen;
...
body = LexicalUnitImpl.createIdent(body, t.image);
    ...
    jj_consume_token(RROUND);
{if ("" != null) return functionInternal(prev, funct, param);}
    throw new Error("Missing return statement in function");
}
...
funct = unescape(t.image, false);
    ...
    calcSum(head);
    jj_consume_token(RROUND);
{if ("" != null) return functionInternal(prev, funct, head.getNextLexicalUnit());}
    throw new Error("Missing return statement in function");
}
...
if (prev instanceof Locatable)
        {
            ((Locatable) prev).setLocator(createLocator(token));
        }
        {if ("" != null) return prev;}
    throw new Error("Missing return statement in function");
}
...
current = LexicalUnitImpl.createComma(current);
    ...
    jj_consume_token(RROUND);
{if ("" != null) return functionInternal(prev, funct, propertyName);}
    throw new Error("Missing return statement in function");
}
...
//   ;
//
  final public Selector negation_arg() throws ParseException {Condition c = null;
...
if (o instanceof Condition)
             {   c = (Condition) o;
                 ...
                 {if ("" != null) return getSelectorFactory().createDescendantSelector(null, (SimpleSelector) o);}
             }
      break;
      }
    default:
...
{if ("" != null) return getSelectorFactory().createConditionalSelector(simpleSel, c);}
    throw new Error("Missing return statement in function");
}
...
try
        ...
        if (value instanceof Locatable)
        {
            ((Locatable) value).setLocator(createLocator(token));
        }
        {if ("" != null) return value;}
    throw new Error("Missing return statement in function");
}
...
value = LexicalUnitImpl.createRem(prev, floatValue(op, t.image));
      break;
      }
    case EXS:{
...
value = LexicalUnitImpl.createCh(prev, floatValue(op, t.image));
      break;
      }
    case VW:{
      t = jj_consume_token(VW);
value = LexicalUnitImpl.createVw(prev, floatValue(op, t.image));
      break;
      }
    case VH:{
      t = jj_consume_token(VH);
value = LexicalUnitImpl.createVh(prev, floatValue(op, t.image));
      break;
      }
    case VMIN:{
      t = jj_consume_token(VMIN);
value = LexicalUnitImpl.createVMin(prev, floatValue(op, t.image));
      break;
      }
    case VMAX:{
      t = jj_consume_token(VMAX);
value = LexicalUnitImpl.createVMax(prev, floatValue(op, t.image));
      break;
      }
    case ANGLE_DEG:{
...
{if ("" != null) return LexicalUnitImpl.createIdent(prev, range.toString().toUpperCase(Locale.ROOT));}
    throw new Error("Missing return statement in function");
}
...
//
  final public LexicalUnit hexcolor(LexicalUnit prev) throws ParseException {Token t;
    t = jj_consume_token(HASH);
{if ("" != null) return hexcolorInternal(prev, t);}
    throw new Error("Missing return statement in function");
}
  ...
  private boolean jj_2_1(int xla)
 {
  ...
  private boolean jj_3R_combinator_972_13_93()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_combinator_972_15_96()) {
    jj_scanpos = xsp;
    if (jj_3R_combinator_972_35_97()) {
    jj_scanpos = xsp;
    if (jj_3R_combinator_972_58_98()) return true;
    }
    }
    return false;
  }

  private boolean jj_3R_attrib_1261_5_107()
 {
    if (jj_scan_token(LSQUARE)) return true;
    return false;
  }

  private boolean jj_3R_combinator_972_58_98()
 {
    if (jj_scan_token(TILDE)) return true;
    return false;
  }

  private boolean jj_3R_pseudo_1351_5_108()
 {
    if (jj_scan_token(COLON)) return true;
    return false;
  }

  private boolean jj_3R_combinator_972_7_90()
 {
    if (jj_scan_token(S)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_combinator_972_13_93()) jj_scanpos = xsp;
    return false;
  }

  private boolean jj_3R_combinator_971_7_89()
 {
    if (jj_scan_token(TILDE)) return true;
    Token xsp;
    while (true) {
  ...
  private boolean jj_3R_combinator_970_7_88()
 {
  ...
  private boolean jj_3R_simpleSelector_1113_5_86()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_simpleSelector_1116_13_91()) {
    jj_scanpos = xsp;
    if (jj_3R_simpleSelector_1132_13_92()) return true;
    }
    return false;
  }

  private boolean jj_3R_hash_1441_5_105()
 {
    if (jj_scan_token(HASH)) return true;
    return false;
  }

  private boolean jj_3R_combinator_969_5_87()
 {
  ...
  private boolean jj_3R_combinator_968_3_85()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_combinator_969_5_87()) {
    jj_scanpos = xsp;
    if (jj_3R_combinator_970_7_88()) {
    jj_scanpos = xsp;
    if (jj_3R_combinator_971_7_89()) {
    jj_scanpos = xsp;
    if (jj_3R_combinator_972_7_90()) return true;
    }
    }
    }
    return false;
  ...
  private boolean jj_3R__class_1198_5_106()
 {
    if (jj_scan_token(DOT)) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1136_19_104()
 {
    if (jj_3R_pseudo_1351_5_108()) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1135_19_103()
 {
    if (jj_3R_attrib_1261_5_107()) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1134_19_102()
 {
    if (jj_3R__class_1198_5_106()) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1133_19_101()
 {
    if (jj_3R_hash_1441_5_105()) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1133_19_95()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_simpleSelector_1133_19_101()) {
    jj_scanpos = xsp;
    if (jj_3R_simpleSelector_1134_19_102()) {
    jj_scanpos = xsp;
    if (jj_3R_simpleSelector_1135_19_103()) {
    jj_scanpos = xsp;
    if (jj_3R_simpleSelector_1136_19_104()) return true;
    }
    }
    }
    return false;
  ...
  private boolean jj_3R_elementName_1235_11_100()
 {
    if (jj_scan_token(ASTERISK)) return true;
    return false;
  }

  private boolean jj_3R_combinator_972_35_97()
 {
    if (jj_scan_token(GREATER)) return true;
    return false;
  }
 ...
 {
    if (jj_3R_combinator_968_3_85()) return true;
    if (jj_3R_simpleSelector_1113_5_86()) return true;
    return false;
  }

  private boolean jj_3R_elementName_1231_9_99()
 {
    if (jj_scan_token(IDENT)) return true;
    return false;
  }

  private boolean jj_3R_simpleSelector_1132_13_92()
 {
    Token xsp;
    if (jj_3R_simpleSelector_1133_19_95()) return true;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3R_simpleSelector_1133_19_95()) { jj_scanpos = xsp; break; }
    }
    return false;
  }

  private boolean jj_3R_elementName_1229_5_94()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3R_elementName_1231_9_99()) {
    jj_scanpos = xsp;
    if (jj_3R_elementName_1235_11_100()) return true;
    }
    return false;
  }

  private boolean jj_3R_simpleSelector_1116_13_91()
 {
    if (jj_3R_elementName_1229_5_94()) return true;
    return false;
  }

  private boolean jj_3R_combinator_972_15_96()
 {
    if (jj_scan_token(PLUS)) return true;
    return false;
  }
