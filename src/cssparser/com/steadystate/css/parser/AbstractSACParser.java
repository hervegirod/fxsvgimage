...
abstract class AbstractSACParser implements SACParser {
    ...
    *
    * This could be done directly in the parser, but portions of the lexer would have to be moved to the parser, meaning that the grammar
    * would no longer match the standard grammar specified by the W3C. This would make the parser and lexer much less maintainable.
    */
